...
using Soenneker.ElevenLabs.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.ElevenLabs.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public FileOperationsUtil(ILogger<FileOperationsUtil> logger, IConfiguration configuration, IGitUtil gitUtil, IDotnetUtil dotnetUtil, IProcessUtil processUtil, 
        IFileDownloadUtil fileDownloadUtil, IFileUtil fileUtil, IDirectoryUtil directoryUtil, IOpenApiFixer openApiFixer, IKiotaUtil kiotaUtil)
    {
        _logger = logger;
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["ElevenLabs:ClientGenerationUrl"] ?? "https://api.elevenlabs.io/openapi.json";
        ...
        await _openApiFixer.Fix(filePath, fixedPath, cancellationToken);
        ...
        await _kiotaUtil.Generate(fixedPath, "ElevenLabsOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
